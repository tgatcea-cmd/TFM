...
final PredictionSchema = Schema(
  ...
  properties: {
    ...
    r'tsMs': PropertySchema(id: 5, name: r'tsMs', type: IsarType.long),
...
Prediction _predictionDeserialize(
  ...
  object.depthCm = reader.readDoubleOrNull(offsets[1]);
  object.kind = reader.readStringOrNull(offsets[2]);
  object.model = reader.readStringOrNull(offsets[3]);
  object.port = reader.readLongOrNull(offsets[4]);
  object.tsMs = reader.readLongOrNull(offsets[5]);
