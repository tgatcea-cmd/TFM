...
import 'metrics/radiation_chart.dart';
import 'metrics/humidity_chart.dart';
import 'metrics/custom_metric_chart.dart';
...
class UnifiedChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int h = now.hour;
    int gatheringStartHour = (forecastZoneEndHour + 1) % 24;
    int fStart = forecastZoneStartHour % 24;
